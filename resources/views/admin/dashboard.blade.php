    ...
    <div class="min-h-screen">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16 items-center">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <span class="inline-flex items-center px-4 py-2 bg-gray-100 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg font-semibold text-xs text-gray-800 dark:text-gray-200 uppercase tracking-widest">Admin</span>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="mb-8">
                ...
                <p class="text-gray-600 dark:text-gray-400 mt-2">Global platform management</p>
            </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 transition-colors duration-500">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="w-16 h-16 bg-gray-100 dark:bg-gray-700 rounded-full flex items-center justify-center">
                            <svg class="w-8 h-8 text-gray-700 dark:text-gray-300" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div class="text-center">
                        ...
                        <div class="relative inline-flex items-center justify-center">
                            <svg class="w-32 h-32 transform -rotate-90">
                                ...
                                <circle cx="64" cy="64" r="52" stroke="currentColor" stroke-width="12" fill="none" stroke-dasharray="{{ 2 * 3.14159 * 52 }}" stroke-dashoffset="{{ 2 * 3.14159 * 52 * (1 - $tenantPercentage / 100) }}" class="text-gray-800 dark:text-gray-200" />
                            </svg>
                            <div class="absolute">
                        ...
                        <div class="mt-4 space-y-2">
                            <div class="flex items-center justify-between text-sm">
                                <span class="flex items-center">
                                    <span class="w-3 h-3 bg-gray-800 dark:bg-gray-200 rounded-full mr-2"></span>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 transition-colors duration-500">
                    <div class="text-center">
                        ...
                        <div class="relative inline-flex items-center justify-center">
                            <svg class="w-32 h-32 transform -rotate-90">
                                <circle cx="64" cy="64" r="52" stroke="currentColor" stroke-width="12" fill="none" class="text-gray-200 dark:text-gray-700" />
                                <circle cx="64" cy="64" r="52" stroke="currentColor" stroke-width="12" fill="none" stroke-dasharray="{{ 2 * 3.14159 * 52 }}" stroke-dashoffset="{{ 2 * 3.14159 * 52 * ($bannedLocals / max($totalLocals, 1)) }}" class="text-gray-800 dark:text-gray-200" />
                            </svg>
                            <div class="absolute">
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-10 w-10 bg-black rounded-full flex items-center justify-center text-white font-bold">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @if($user->status === 'blocked')
                                        <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-gray-200 text-gray-800">Banned</span>
                                    @else
                                        <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-black text-white">Active</span>
                                    @endif
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    @if($user->status === 'blocked')
                                        <form method="POST" action="{{ route('admin.users.unban', $user) }}" class="inline">
                                            @csrf
                                            <button type="submit" class="px-3 py-1 bg-black text-white rounded-lg hover:opacity-75 transition">Unban</button>
                                        </form>
                                    @else
                                        <form method="POST" action="{{ route('admin.users.ban', $user) }}" class="inline">
                                            @csrf
                                            <button type="submit" class="px-3 py-1 bg-gray-200 text-gray-800 rounded-lg hover:bg-gray-300 transition">Ban</button>
                                        </form>
                                    @endif
                                </td>
                            </tr>
                            @empty
                            <tr>
                                <td colspan="7" class="px-6 py-12 text-center text-gray-500 dark:text-gray-400">No users found</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            @empty
                            <tr>
                                <td colspan="7" class="px-6 py-12 text-center text-gray-500 dark:text-gray-400">No locals found</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
